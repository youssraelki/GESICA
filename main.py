...
def background_process(job_id: str, file_path: str):
    try:
...
def load_models():
    global whisper_model, retriever
...
# ====================== LLM & AGENTS ======================
# ====================== LLM & AGENTS ======================
GROQ_API_KEY = os.getenv("GROQ_API_KEY")  # ← Colle ta clé ici
...
async def process_audio(
    ...
    # 🔥 Traitement en arrière-plan (clé de la solution)
    background_tasks.add_task(background_process, job_id, str(temp_path))
